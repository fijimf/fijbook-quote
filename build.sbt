...
lazy val root = (project in file("."))
  .settings(
    ...
    buildInfoPackage := "com.fijimf.deepfij.quote",
...
packageSummary in Docker := "REST microservice to handle cute and pithy quote of the days"
packageDescription := "REST microservice to handle cute and pithy quote of the days"
